...
public class DocumentViewer {
    ...
    public ArrayList<String> getDocuments() throws IOException {
        ...
        downloadFile(finalFiles.get(1));
        return finalFiles;
    }
    public void setFiles(ArrayList<String> x){
        this.documentList = x;
    ...
    public ArrayList<String> getList(){
        ...
        public void downloadFile(String filelink) throws IOException {
